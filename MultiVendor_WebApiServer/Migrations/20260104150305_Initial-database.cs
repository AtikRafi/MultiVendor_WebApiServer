    ...
    public partial class Initialdatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VendorOwners", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VendorOwners_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VendorSlug = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    VendorDescription = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    VendorLogoUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    VendorBannerUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ...
                    TradeLicenseNo = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    VendorOwnerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Vendors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Vendors_VendorOwners_VendorOwnerId",
                        column: x => x.VendorOwnerId,
                        principalTable: "VendorOwners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductPropertyValues_CategoryProperties_CategoryPropertyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductVariantPropertyValues_CategoryProperties_CategoryPropertyId",
                        column: x => x.CategoryPropertyId,
                        principalTable: "CategoryProperties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductVariantPropertyValues_ProductVariants_ProductVariantId",
                        column: x => x.ProductVariantId,
                        principalTable: "ProductVariants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Name" },
                values: new object[] { new Guid("33333333-3333-3333-3333-333333333333"), "Electronics" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductPropertyValues_CategoryPropertyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantPropertyValues_CategoryPropertyId",
                table: "ProductVariantPropertyValues",
                column: "CategoryPropertyId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantPropertyValues_ProductVariantId",
                table: "ProductVariantPropertyValues",
                column: "ProductVariantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VendorOwners_NIDNumber",
                table: "VendorOwners",
                column: "NIDNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_VendorOwners_UserId",
                table: "VendorOwners",
                column: "UserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Vendors_VendorOwnerId",
                table: "Vendors",
